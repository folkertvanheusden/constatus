...
void myjpeg::rgb_to_i420(tjhandle t, const uint8_t *const in, const int width, const int height, uint8_t **const out, uint8_t **const y, uint8_t **const u, uint8_t **const v)
{
