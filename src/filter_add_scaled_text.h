...
public:
	filter_add_scaled_text(const std::string & what, const std::vector<std::string> & font_files, const int x, const int y, const int font_size, const int width, std::optional<rgb_t> bg, const rgb_t col, const bool invert, const std::map<std::string, feed *> & text_feeds);
